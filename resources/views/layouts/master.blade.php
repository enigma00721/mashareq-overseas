...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="#" class="brand-link text-center" style="font-size: 1.35rem;">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <p class="text-cyan text-upper">{{Auth::user()->type}}</p>
        </div>
      </div>
          ...
          @endcan
           ...
           <li class="nav-item">
            <router-link to="/category" class="nav-link">
              <i class="nav-icon fas fa-bezier-curve text-cyan"></i>
              <!-- <i class="nav-icon fas fa-file-alt text-cyan"></i> -->
              <p>
                Category
              </p>
            </router-link>
           ...
           <li class="nav-item">
            <router-link to="/event" class="nav-link" active-class="active">
              <i class="nav-icon fas fa-closed-captioning text-teal"></i>
              <p>
                Event
              </p>
            </router-link>
           ...
           <li class="nav-item">
            <router-link to="/menubuilder" class="nav-link">
